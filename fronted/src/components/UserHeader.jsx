...
const UserHeader = () => {
  ...
  const handleSearch = () => {
    if (searchTerm) {
      navigate.push(`/homeProperty?query=${encodeURIComponent(searchTerm)}`); // Navigate to Property page with query parameter
    }
  };
  useEffect(() => {
    ...
    <div className={`header-wrapper ${isBottom ? "scrolled-to-bottom" : ""} ${isMenuOpen ? "open" : ""}`}>
      <div className="container">
        <div className="row header-main">
          ...
          <div className="col-md-7 col-12 header-menu">
            <ul className="menu">
          ...
          <div className="col-md-2 col-12">
            <ul className="d-flex align-items-center justify-content-around">
              <li className="d-md-block d-none dropdown">
                ...
                >
                  {isAuthenticated ? (
                    <div> <svg xmlns="http://www.w3.org/2000/svg" className="me-2" viewBox="0 0 448 512" height={15} width={15} fill="#ff5a3c"><path d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512l388.6 0c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304l-91.4 0z"/></svg>{user.name}!</div>
                  ) : (
